...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "6MgWJrMWpGUUh69FP5BX3HY0i", consumerSecret: "bRrCpv4daDdsTcUyQQXs7DiBVNCKAugRZi57klZGXClwUTmmBC")
    var loginSuccess: (() -> ())?
